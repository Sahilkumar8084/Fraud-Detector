...
class Fraud:
    ...
    def __init__(self):
        self.minmaxscaler = joblib.load(r'C:\Users\sahil\OneDrive\Documents\Machine learning\Fraud_detection\minmaxscaler_cycle1.joblib')
        self.onehotencoder = joblib.load(r'C:\Users\sahil\OneDrive\Documents\Machine learning\Fraud_detection\onehotencoder_cycle1.joblib')
